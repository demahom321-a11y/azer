      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="glass-panel rounded-lg overflow-hidden relative border border-red-500/20">
          ...
          <div className="p-6 relative">
            ...
            <div className="mt-6">
              <a href="https://amzn.to/3N4skD2" target="_blank" rel="noopener noreferrer" className="block w-full bg-gradient-to-r from-red-700 via-red-600 to-red-700 hover:from-red-600 hover:via-red-500 hover:to-red-600 text-white font-bold py-3.5 px-4 rounded-lg text-xs uppercase tracking-[0.15em] animate-cta-pulse transition-all duration-300 border border-red-500/30 cursor-pointer text-center">
